...
st.set_page_config(page_title="Driver Telemetry Comparison", layout="centered", page_icon="📈")
...
def plot_driver_telemetry(session: fastf1.core.Session, metric: str, metric_label: str) -> go.Figure:
    """
...
with st.sidebar:
    ...
    try:
        ...
        selected_metric_label = st.selectbox(
            'Select Car Data Metric', 
            list(CAR_DATA_METRICS.keys()), 
            index=0
        )
...
st.write("This visualization compares driver telemetry data to analyze performance differences around the track.")
