...
def get_driver_info(session_results, driver_identifier: str) -> Optional[Dict]:
    ...
    try:
        ...
        if 'Abbreviation' in session_results.columns:
            driver_rows = session_results[session_results['Abbreviation'] == driver_identifier.upper()]
    ...
    try:
        ...
        if driver_info:
            ...
            if isinstance(classified_pos, str):
                ...
                if classified_pos in ['R', 'D', 'E', 'W']:  # Retired, Disqualified, Excluded, Withdrawn
                    return True
...
def get_driver_team_info(session_results, driver_identifier: str) -> Dict:
    ...
    return {
        ...
        'country_code': get_driver_country_code(session_results, driver_identifier) or '',
